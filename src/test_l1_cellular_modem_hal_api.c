...
/**
* @file test_l1_cellular_modem_hal_api.c
...
* **Dependencies:** None@n
*
* Ref to API Definition specification documentation : [CellularModemHalSpec.md](../../../docs/CellularModemHalSpec.md)
*/
 ...
 */
int test_cellular_modem_hal_api_l1_register(void)
{
